...
call <sid>hi('xmlTagName',                 s:base0C, '',       '',          '')
...
call <sid>hi('jsImport',                s:base0E, s:base00, s:bold,      '')
call <sid>hi('jsFrom',                  s:base0E, s:base00, s:bold,      '')
call <sid>hi('jsClassDefinition',       s:base05, s:base00, s:bold,      '')
call <sid>hi('jsClassFuncName',         s:base09, s:base00, s:bold,      '')
